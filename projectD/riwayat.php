...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Riwayat Penjadwalan Anda</h3>
          <span class="breadcrumb"><a href="#"></a><a href="#"></a> Silahkan Cek Riwayat Anda</span>
        </div>
      </div>
    </div>
  </div>
...
$query = "SELECT * FROM jadwal WHERE status = 1";
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
                ...
                <td>Selesai</td>
                <td>
                <a href='hapus_jadwalR.php?id=" . $row['id'] . "' class='btn btn-danger' onclick='return confirm(\"Anda yakin Ingin Menghapus Data?\")'>
